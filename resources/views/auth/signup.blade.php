...
<div class="container-fluid">
    <form action="/login" method="post" class="w-75 mt-3 mx-auto">
        ...
        <div class="form-floating mb-3 w-75 mx-auto">
            <input type="password" class="form-control border border-dark" id="passwordInput" name="passwordConfirm" placeholder="Password Confirm"
                required oninvalid="this.setCustomValidity('Please Enter Password!')" oninput="setCustomValidity('')">
            <label for="passwordInput" class="placeholders"><svg class="svgsub me-1" width="20" height="20"><use href="#password"></svg>Password Confirm</label>
        </div>
